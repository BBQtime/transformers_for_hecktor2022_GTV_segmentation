...
from nnunet.network_architecture.transformers.dynunet_block import UnetOutBlock, UnetResBlock
from nnunet.network_architecture.transformers.model_components import UnetrPPEncoder, UnetrUpBlock
...
class UNETR_PP(SegmentationNetwork):
    ...
    def __init__(
        ...
        self.num_classes = out_channels #num_classes
        #out_channels
        ...
        self.feat_size = (
            img_size[0] // self.patch_size[0] // 16,  # 2*len(depths) is the downsampling happened through the four encoders stages default 8
            img_size[1] // self.patch_size[1] // 16,  # 8 is the downsampling happened through the four encoders stages
            img_size[2] // self.patch_size[2] // 16,  # 8 is the downsampling happened through the four encoders stages
        )
    ...
    def proj_feat(self, x, hidden_size, feat_size):
        #print('proj_feat', x.shape, x.size(0),  feat_size[0], feat_size[1], feat_size[2], hidden_size)
    ...
    def forward(self, x_in):
        ...
        #print(enc4.shape)
        enc5 = hidden_states[4]
        #print("enc5.shape", enc5.shape)
        # Four decoders
        dec5 = self.proj_feat(enc5, self.hidden_size, self.feat_size)
        #dec4 = self.proj_feat(enc4, self.hidden_size, self.feat_size)
        dec4 = self.decoder6(dec5, enc4)
